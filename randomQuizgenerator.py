...
#Os dados para as provas. As keys são estados e os values são as capitais.
...
'New Mexico': 'Santa Fe', 'New York': 'Albany', 'North Carolina': 'Raleigh', 'North Dakota':
...
for quizNum in range(35):
    #TODO: criar os arquivos com as provas e os gabaritos das respostas.
    ...
    #TODO: Percorre todos os 50 estados em um loop, criando uma pergunta pra cada um.
